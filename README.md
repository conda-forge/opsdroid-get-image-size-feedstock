About opsdroid-get-image-size-feedstock
=======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opsdroid-get-image-size-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10070&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opsdroid-get-image-size-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opsdroid-get-image-size` can be installed with `conda`:
...
```
mamba install opsdroid-get-image-size
```

It is possible to list all of the versions of `opsdroid-get-image-size` available on your platform with `conda`:
...
```
mamba search opsdroid-get-image-size --channel conda-forge
```
...
mamba repoquery search opsdroid-get-image-size --channel conda-forge

# List packages depending on `opsdroid-get-image-size`:
mamba repoquery whoneeds opsdroid-get-image-size --channel conda-forge

# List dependencies of `opsdroid-get-image-size`:
mamba repoquery depends opsdroid-get-image-size --channel conda-forge
```
